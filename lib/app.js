...
$('#myModal').on('show.bs.modal', function (event) {
  ...
  ga("send", "event", { eventCategory: "Product Preview", eventAction: "click", eventLabel: location.pathname + match, transport: "beacon" });
...
*/
    ...
    $(document).ready(function() {
      ...
      /* does not work for links in sidebar because propagation is being stopped
      $('a.listitem-thumbnail').on('click', function() {
          console.log('link with class of listitem-thumbnail was clicked');
