...
*/
        ...
        '<ul class="dropdown-menu">'+
          '<li><a href="'+layer.feature.properties.product_pdf+'">PDF</a></li>'+
          '<li><a href="'+layer.feature.properties.product_jpg+'">JPG</a></li>'+
        '</ul>'+ '<a href="https://twitter.com/intent/tweet?text='+layer.feature.properties.tweet+'&url=www.test.html"><img src="{{ site.baseurl }}/assets/img/Twitter_Logo_Blue.png" style="width: 40px;margin-left:15px"></a>'+
        '</div></div>');
