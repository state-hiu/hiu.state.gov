...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        '</ul>'+ '<a href="https://twitter.com/intent/tweet?text='+layer.feature.properties.tweet+'&url=hiu.state.gov"><img src="{{ site.baseurl }}/assets/img/Twitter_Logo_Blue.png" style="width: 40px;margin-left:15px"></a>'+
        '</div></div>');
