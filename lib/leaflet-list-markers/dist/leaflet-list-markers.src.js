    ...
    _createItem: function(layer) {
        ...
        if (layer.feature.properties.region_id == activeLayer) {
           ...
           if ( JpegLength > 1) {
            ...
            console.log('active cluster Layer');

            var activeClusterLayer = activeLayer + 'markers';

            console.log(activeClusterLayer);
            ...
            $(link).mouseover(function(){
                ...
                if ($(link).hasClass( "global" )) {
                    ...
                    //var marker1 = map._layers;

                    //marker1 = map.getLayer(clickedListing._leaflet_id);
                    ...
                    console.log('SCAmarkers is: ');
                    console.log(SCAmarkers);
                    ...
                    /*map.eachLayer(function(layer){     //iterate over map rather than clusters
                     if (layer.getChildCount){         // if layer is markerCluster
                      ...
                      console.log(layer);
                        ...
                        layer.marker.addClass('selectedMarker');
                      }
                    });*/

                    //var visibleOne = SCAmarkers.getVisibleParent(marker1);
                    //console.log(visibleOne);


                    //visibleOne.addClass('selectedMarker');
            ...
            $(link).click(function(){
                ...
                //this code is used to move the active dive to the top of the sidebar
                ...
                //var clickedListing = activeClusterLayer.getLayer(clickedListing._leaflet_id);
