...
//loops used in old code
            if (layer.feature.properties.product_jpg_pg2) {
                console.log('it exists');

                //This selector below selects the div wiht a parent class of dropdown-menu and
                //that has a parent that is a div with a title attribute that has 
                //the value of the currentFeature variable
                //$( "div[title='"+currentFeature+"'] .dropdown-menu" )
                //$( "div[title='"+currentFeature+"'] .dropdown-menu" ).append('<li><a href="'+layer.feature.properties.product_jpg_pg2+'">JPG - page 2</a></li>');
            }

            if (layer.feature.properties.product_jpg_pg3) {
                console.log('it exists 3');

                //This selector below selects the div wiht a parent class of dropdown-menu and
                //that has a parent that is a div with a title attribute that has 
                //the value of the currentFeature variable
                //$( "div[title='"+currentFeature+"'] .dropdown-menu" )
                //$( "div[title='"+currentFeature+"'] .dropdown-menu" ).append('<li><a href="'+layer.feature.properties.product_jpg_pg3+'">JPG - page 3</a></li>');
            }
