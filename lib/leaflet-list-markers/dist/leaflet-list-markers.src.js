...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        '<ul class="dropdown-menu">'+
          ...
          '<li><a class="jpg" onclick="ga(&apos;send&apos;, &apos;event&apos;, { eventCategory: &apos;product&apos;, eventAction: &apos;download - PDF&apos;, eventLabel: &apos;#'+layer.feature.properties.region_id+','+layer.feature.properties.product_id+'&apos;, transport: &apos;beacon&apos; });" href="'+layer.feature.properties.product_jpg+'">JPG</a></li>'+
