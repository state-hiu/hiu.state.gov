...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        '<ul class="dropdown-menu">'+
          '<li><a class="pdf" onclick="ga(&apos;send&apos;, &apos;event&apos;, { eventCategory: &apos;product&apos;, eventAction: &apos;download - PDF&apos;, eventLabel: event.target.href, transport: &apos;beacon&apos; });" href="'+layer.feature.properties.product_pdf+'">PDF</a></li>'+
