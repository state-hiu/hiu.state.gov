...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        '<ul class="dropdown-menu">'+
          '<li><a class="pdf" onclick="ga(&apos;send&apos;, &apos;event&apos;, { eventCategory: &apos;PDF Product Download&apos;, eventAction: &apos;click&apos;, eventLabel: event.target.href, transport: &apos;beacon&apos; });" href="'+layer.feature.properties.product_pdf+'">PDF</a></li>'+
          '<li><a class="jpg" onclick="ga(&apos;send&apos;, &apos;event&apos;, { eventCategory: &apos;JPG Product Download&apos;, eventAction: &apos;click&apos;, eventLabel: event.target.href, transport: &apos;beacon&apos; });" href="'+layer.feature.properties.product_jpg+'">JPG</a></li>'+
