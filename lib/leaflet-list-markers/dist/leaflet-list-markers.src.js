...
*/
	    ...
	    '<a class="listitem-thumbnail" data-toggle="modal" data-target="#myModal" data-title="test"'+
	    ' data-img="test"'+
	    ' >'+
	    ...
	    '<div id="hover" style="height:150px;width:150px;"></div>'+
	    '<div id="preview"><span style="line-height: 150px;">Preview</span></div></a>'+
	    '</div>'+
	    '</div>'+
