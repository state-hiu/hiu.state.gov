...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        if (layer.feature.properties.interactive == true) {
            ...
            var button_text = '<a href=' + layer.feature.properties.baseurl + ' class="btn btn-primary" style="padding: 3px 10px;background-color:#269419;color:#fff" type="button">View</a>'
        } else {
