...
L.Control.ListMarkers = L.Control.extend({
    ...
    _createItem: function(layer) {
        ...
        '</ul>'+ '<a href="https://twitter.com/intent/tweet?text='+layer.feature.properties.tweet+'https://hiu.state.gov/%23' + layer.feature.properties.region_id + '%23' + layer.feature.properties.product_id +'"><img src="{{ site.baseurl }}/assets/img/Twitter_Logo_Blue.png" style="width: 40px;margin-left:15px"></a>'+
        '</div></div>');
